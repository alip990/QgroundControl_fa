...
Item {
    ...
    readonly property string emergencyStopTitle:            qsTr("توقف اظطراری")
    readonly property string armTitle:                      qsTr("آماده به کار")
    readonly property string disarmTitle:                   qsTr("غیرفعال")
    readonly property string rtlTitle:                      qsTr("برگشت")
    readonly property string takeoffTitle:                  qsTr("برخاستن")
    readonly property string landTitle:                     qsTr("فرود")
    readonly property string startMissionTitle:             qsTr("شروع عملیات")
    readonly property string mvStartMissionTitle:           qsTr("شروع عملیات (MV)")
    readonly property string continueMissionTitle:          qsTr("ادامه ماموریت")
    readonly property string resumeMissionUploadFailTitle:  qsTr("از سرگیری عملیات ناموفق")
    readonly property string pauseTitle:                    qsTr("درنگ")
    readonly property string mvPauseTitle:                  qsTr("درنگ (MV)")
    readonly property string changeAltTitle:                qsTr("تغییر ارتفاع")
    readonly property string orbitTitle:                    qsTr("چرخش در مدار")
    readonly property string landAbortTitle:                qsTr("فرود لغو شد")
    readonly property string setWaypointTitle:              qsTr("نقطه مسیر را مشخص کنید")
    readonly property string gotoTitle:                     qsTr("به مکان بروید")
    readonly property string vtolTransitionTitle:           qsTr("VTOL Transition")
    readonly property string roiTitle:                      qsTr("نقطه زیر نظر")
    readonly property string actionListTitle:               qsTr("دستور")

    readonly property string armMessage:                        qsTr("پرنده را آماده به کار کنید")
    readonly property string disarmMessage:                     qsTr("پرنده را غیر فعال کنید")
    readonly property string emergencyStopMessage:              qsTr("هشدار: این کار تمام موتورها را متوقف می کند. اگر پرنده در هوا باشد ، خراب خواهد شد")
    readonly property string takeoffMessage:                    qsTr("از زمین بلند شوید و موقعیت خود را حفظ کنید")
    readonly property string startMissionMessage:               qsTr("از زمین بلند شوید و ماموریت فعلی را شروع کنید")
    readonly property string continueMissionMessage:            qsTr("مأموریت را از نقطه مسیر فعلی ادامه دهید.")
    readonly property string resumeMissionUploadFailMessage:    qsTr("بارگذاری مأموریت  انجام نشد. برای امتحان مجدد بارگذاری ، تأیید کنید")
    readonly property string landMessage:                       qsTr("پرنده را در موقعیت فعلی بنشانید")
    readonly property string rtlMessage:                        qsTr("به موقعیت شروع برگردید.")
    readonly property string changeAltMessage:                  qsTr("ارتفاع پرنده را کم یا زیاد کنید.")
    readonly property string gotoMessage:                       qsTr("پرنده را به موقعیت مشخص شده ببرید")
             property string setWaypointMessage:                qsTr("نقطه مسیر فعلی به %1.تنظیم کنید").arg(_actionData)
    readonly property string orbitMessage:                      qsTr("پرنده در مدار مشخص حول نقطه مشخص شده بچرخد")
    readonly property string landAbortMessage:                  qsTr("فرود را لغو کنید.")
    readonly property string pauseMessage:                      qsTr("پرنده را در موقعیت فعلی متوقف کنید و در صورت لزوم ارتفاع را به سمت بالا یا پایین تنظیم کنید.
")
    readonly property string mvPauseMessage:                    qsTr("تمام پرنده ها را در موقعیت فعلی خود  متوقف کنید.")
    readonly property string vtolTransitionFwdMessage:          qsTr("انتقال VTOL به پرواز بال ثابت.")
    readonly property string vtolTransitionMRMessage:           qsTr("انتقال VTOL به پرواز مولتی روتور.")
    readonly property string roiMessage:                        qsTr("یک نقطه زیر نظر مشخص کنید تا جهت پرنده رو به ان باشد")
